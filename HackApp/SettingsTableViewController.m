...
- (void)viewDidLoad {
    ...
    [_displayTitle setDelegate:self];
   ...
   /*
    ...
    [[_appDelegate manager] advertiseSelf:_switchVisible.isOn];
    */
...
-(BOOL)textFieldShouldReturn:(UITextField *)textField{
    [_displayTitle resignFirstResponder];
    ...
    [_appDelegate.manager setupPeerAndSessionWithDisplayName:_displayTitle.text];
